    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        if (strings.length !=5) {
            ...
            try {
                ...
                StringBuilder result = new StringBuilder("Получены данные: производительность буровых насосов - " + Q + " л/с; объём трубного пространства - " + V_tr + " м3 " +
                        "объём затрубного пространства - " + V_ztr + "м3; объём наружней обвязки - " + V_obv + " м3; " +
                        "объём пачки - "+ V_pch + "м3");
